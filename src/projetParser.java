// $ANTLR 3.5.2 projet.g 2019-04-02 17:23:08
...
public class projetParser extends Parser {
		...
		try {
			...
			switch (alt5) {
				case 1 :
					// projet.g:53:51: vars
					{
					pushFollow(FOLLOW_vars_in_declarations185);
					vars();
					state._fsp--;
			...
			switch (alt6) {
				case 1 :
					// projet.g:53:57: decprocs
					{
					pushFollow(FOLLOW_decprocs_in_declarations188);
					decprocs();
					state._fsp--;
	...
	public final void partiedef() throws RecognitionException {
		try {
			...
			{
			match(input,31,FOLLOW_31_in_partiedef205); 
		...
		try {
			...
			switch (alt10) {
				case 1 :
					...
					match(input,11,FOLLOW_11_in_specif287); 
					}
					break;
			...
			switch (alt12) {
				case 1 :
					...
					{
					match(input,44,FOLLOW_44_in_specif312); 
					...
					match(input,11,FOLLOW_11_in_specif332); 
					}
					break;
	...
	public final void consts() throws RecognitionException {
		try {
			...
			{
			match(input,29,FOLLOW_29_in_consts350); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_ident_in_consts354);
					ident();
					state._fsp--;

					match(input,22,FOLLOW_22_in_consts356); 
					pushFollow(FOLLOW_valeur_in_consts358);
					valeur();
					state._fsp--;
	...
	public final void vars() throws RecognitionException {
		try {
			...
			{
			match(input,54,FOLLOW_54_in_vars382); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_type_in_vars386);
					type();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_vars394); 
					...
					pushFollow(FOLLOW_ptvg_in_vars404);
					ptvg();
					state._fsp--;
		...
		try {
			...
			switch (alt16) {
				case 1 :
					// projet.g:73:9: 'ent'
					{
					match(input,34,FOLLOW_34_in_type424); 
					PtGen.pt(33);
					}
					break;
				case 2 :
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_decproc_in_decprocs453);
					decproc();
					state._fsp--;

					pushFollow(FOLLOW_ptvg_in_decprocs455);
					ptvg();
					state._fsp--;
	...
	public final void decproc() throws RecognitionException {
		try {
			...
			pushFollow(FOLLOW_corps_in_decproc494);
			corps();
			state._fsp--;
		...
		try {
			...
			switch (alt22) {
				case 1 :
					// projet.g:83:9: ';'
					{
					match(input,18,FOLLOW_18_in_ptvg510); 
					}
					break;
				case 2 :
					// projet.g:85:3: 
	...
	public final void corps() throws RecognitionException {
		try {
			...
			{
			match(input,30,FOLLOW_30_in_corps528); 
			pushFollow(FOLLOW_instructions_in_corps530);
			instructions();
			state._fsp--;

			match(input,40,FOLLOW_40_in_corps532); 
			PtGen.pt(255);
			}
	...
	public final void parmod() throws RecognitionException {
		try {
			...
			{
			match(input,44,FOLLOW_44_in_parmod604); 
			match(input,10,FOLLOW_10_in_parmod606); 
			...
			while (true) {
				...
				case 1 :
					// projet.g:96:26: ';' pm
					{
					match(input,18,FOLLOW_18_in_parmod612); 
			...
			match(input,11,FOLLOW_11_in_parmod618); 
			}
	...
	public final void pm() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_type_in_pm632);
			type();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_pm640); 
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			match(input,25,FOLLOW_25_in_inssi738); 
			...
			switch (alt29) {
				case 1 :
					...
					{
					match(input,52,FOLLOW_52_in_inssi743); 
					PtGen.pt(51);
			...
			match(input,42,FOLLOW_42_in_inssi752); 
			PtGen.pt(52);
			}
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			{
			match(input,28,FOLLOW_28_in_inscond768); 
			PtGen.pt(56);
			...
			while (true) {
				...
				case 1 :
					...
					PtGen.pt(58);
					pushFollow(FOLLOW_expression_in_inscond798);
					expression();
					state._fsp--;

					PtGen.pt(8);PtGen.pt(57);
					match(input,16,FOLLOW_16_in_inscond802); 
					pushFollow(FOLLOW_instructions_in_inscond804);
					instructions();
					state._fsp--;
			...
			switch (alt31) {
				case 1 :
					...
					{
					match(input,26,FOLLOW_26_in_inscond821); 
			...
			match(input,39,FOLLOW_39_in_inscond845); 
			PtGen.pt(60);
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,53,FOLLOW_53_in_boucle863); 
			PtGen.pt(53);
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture890); 
			match(input,10,FOLLOW_10_in_lecture892); 
			...
			match(input,11,FOLLOW_11_in_lecture911); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture924); 
			match(input,10,FOLLOW_10_in_ecriture926); 
			pushFollow(FOLLOW_expression_in_ecriture928);
			expression();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_ecriture934); 
					pushFollow(FOLLOW_expression_in_ecriture936);
					expression();
					state._fsp--;
			...
			match(input,11,FOLLOW_11_in_ecriture943); 
			}
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel959);
			ident();
			state._fsp--;
			...
			switch (alt36) {
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_affouappel968); 
					pushFollow(FOLLOW_expression_in_affouappel971);
					expression();
					state._fsp--;
				...
				case 2 :
					...
					switch (alt35) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel993);
							effixes();
							state._fsp--;
							...
							switch (alt34) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel996);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effixes1030); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effixes1038); 
			...
			match(input,11,FOLLOW_11_in_effixes1049); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effmods1061); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effmods1069); 
			...
			match(input,11,FOLLOW_11_in_effmods1081); 
			}
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_exp11126); 
					PtGen.pt(8);
		...
		try {
			...
			switch (alt43) {
				...
				case 2 :
					// projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21161);
					exp3();
					state._fsp--;
		...
		try {
			...
			switch (alt44) {
				case 1 :
					// projet.g:157:5: '=' exp4
					{
					match(input,22,FOLLOW_22_in_exp31184); 
					PtGen.pt(7);
				...
				case 3 :
					// projet.g:159:5: '>' exp4
					{
					match(input,23,FOLLOW_23_in_exp31214); 
					PtGen.pt(7);
				...
				case 4 :
					// projet.g:160:5: '>=' exp4
					{
					match(input,24,FOLLOW_24_in_exp31229); 
					PtGen.pt(7);
				...
				case 5 :
					...
					PtGen.pt(7);
					pushFollow(FOLLOW_exp4_in_exp31249);
					exp4();
					state._fsp--;
				...
				case 6 :
					// projet.g:162:5: '<=' exp4
					{
					match(input,20,FOLLOW_20_in_exp31258); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp4_in_exp31263);
					exp4();
					state._fsp--;
	...
	public final void exp4() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp5_in_exp41286);
			exp5();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_exp41298); 
					PtGen.pt(7);
				...
				case 2 :
					...
					{
					match(input,15,FOLLOW_15_in_exp41316); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp5_in_exp41320);
					exp5();
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_exp51384); 
					PtGen.pt(7);
					pushFollow(FOLLOW_primaire_in_exp51388);
					primaire();
					state._fsp--;
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1413);
					valeur();
					state._fsp--;
		...
		try {
			...
			switch (alt48) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_nbentier_in_valeur1448);
					nbentier();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1456); 
					pushFollow(FOLLOW_nbentier_in_valeur1458);
					nbentier();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,15,FOLLOW_15_in_valeur1466); 
				...
				case 4 :
					// projet.g:186:5: 'vrai'
					{
					match(input,55,FOLLOW_55_in_valeur1476); 
					PtGen.pt(3);
					}
					break;
				case 5 :
					// projet.g:187:5: 'faux'
					{
					match(input,38,FOLLOW_38_in_valeur1484); 
					PtGen.pt(4);
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// projet.g:197:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1514); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// projet.g:199:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1525); 
	...
	public static final BitSet FOLLOW_vars_in_declarations185 = new BitSet(new long[]{0x0001000000000002L});
	public static final BitSet FOLLOW_decprocs_in_declarations188 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_31_in_partiedef205 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_11_in_specif287 = new BitSet(new long[]{0x0000100000000002L});
	public static final BitSet FOLLOW_44_in_specif312 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_specif315 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_specif317 = new BitSet(new long[]{0x0000000000004800L});
	...
	public static final BitSet FOLLOW_11_in_specif332 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_29_in_consts350 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_consts354 = new BitSet(new long[]{0x0000000000400000L});
	public static final BitSet FOLLOW_22_in_consts356 = new BitSet(new long[]{0x008000400000A040L});
	public static final BitSet FOLLOW_valeur_in_consts358 = new BitSet(new long[]{0x0000000000040020L});
	public static final BitSet FOLLOW_ptvg_in_consts361 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_54_in_vars382 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_vars386 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_vars388 = new BitSet(new long[]{0x0000000408044000L});
	public static final BitSet FOLLOW_14_in_vars394 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_vars397 = new BitSet(new long[]{0x0000000408044000L});
	public static final BitSet FOLLOW_ptvg_in_vars404 = new BitSet(new long[]{0x0000000408000002L});
	public static final BitSet FOLLOW_34_in_type424 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_type437 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_decproc_in_decprocs453 = new BitSet(new long[]{0x0001000000040000L});
	public static final BitSet FOLLOW_ptvg_in_decprocs455 = new BitSet(new long[]{0x0001000000000002L});
	...
	public static final BitSet FOLLOW_corps_in_decproc494 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_ptvg510 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_30_in_corps528 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_corps530 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_40_in_corps532 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_44_in_parmod604 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_parmod606 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pm_in_parmod608 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_18_in_parmod612 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pm_in_parmod614 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_11_in_parmod618 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pm632 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm634 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_14_in_pm640 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_18_in_instructions666 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instruction_in_instructions668 = new BitSet(new long[]{0x0000000000040002L});
	public static final BitSet FOLLOW_inssi_in_instruction685 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_inscond_in_instruction691 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_boucle_in_instruction697 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lecture_in_instruction703 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ecriture_in_instruction709 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_affouappel_in_instruction715 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_51_in_inssi732 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inssi734 = new BitSet(new long[]{0x0000000002000000L});
	public static final BitSet FOLLOW_25_in_inssi738 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inssi740 = new BitSet(new long[]{0x0010040000000000L});
	public static final BitSet FOLLOW_52_in_inssi743 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inssi748 = new BitSet(new long[]{0x0000040000000000L});
	public static final BitSet FOLLOW_42_in_inssi752 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_inscond768 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_14_in_inscond793 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inscond798 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_inscond802 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond804 = new BitSet(new long[]{0x0000008004004000L});
	public static final BitSet FOLLOW_26_in_inscond821 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond827 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_inscond845 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_53_in_boucle863 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_43_in_lecture890 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture892 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_11_in_lecture911 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture924 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture926 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture928 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_ecriture934 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture936 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_ecriture943 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel959 = new BitSet(new long[]{0x0000000000020402L});
	public static final BitSet FOLLOW_17_in_affouappel968 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_affouappel971 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel993 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_effmods_in_affouappel996 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effixes1030 = new BitSet(new long[]{0x008040400000AC60L});
	public static final BitSet FOLLOW_expression_in_effixes1033 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effixes1038 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_effixes1040 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effixes1049 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effmods1061 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_ident_in_effmods1064 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effmods1069 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods1071 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effmods1081 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_35_in_exp11126 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_exp3_in_exp21161 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31177 = new BitSet(new long[]{0x0000000001F80002L});
	public static final BitSet FOLLOW_22_in_exp31184 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_23_in_exp31214 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31220 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_exp31229 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_exp4_in_exp31249 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp31258 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31263 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp5_in_exp41286 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_13_in_exp41298 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41302 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_15_in_exp41316 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41320 = new BitSet(new long[]{0x000000000000A002L});
	...
	public static final BitSet FOLLOW_32_in_exp51384 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51388 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1413 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_nbentier_in_valeur1448 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1456 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1458 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_valeur1466 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1468 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_valeur1476 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1484 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1514 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1525 = new BitSet(new long[]{0x0000000000000002L});
}
