// $ANTLR 3.5.2 projet.g 2019-04-04 05:08:40
...
public class projetParser extends Parser {
	...
	public final void unitmodule() throws RecognitionException {
		try {
			...
			PtGen.pt(81);
			pushFollow(FOLLOW_ident_in_unitmodule144);
			ident();
			state._fsp--;

			match(input,16,FOLLOW_16_in_unitmodule146); 
		...
		try {
			...
			switch (alt3) {
				case 1 :
					// projet.g:53:32: partieref
					{
					pushFollow(FOLLOW_partieref_in_declarations179);
					partieref();
					state._fsp--;
			...
			switch (alt4) {
				case 1 :
					// projet.g:53:43: consts
					{
					pushFollow(FOLLOW_consts_in_declarations182);
					consts();
					state._fsp--;
			...
			switch (alt5) {
				case 1 :
					// projet.g:53:67: vars
					{
					pushFollow(FOLLOW_vars_in_declarations187);
					vars();
					state._fsp--;
	...
	public final void partiedef() throws RecognitionException {
		try {
			...
			{
			match(input,31,FOLLOW_31_in_partiedef209); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_partiedef216); 
					pushFollow(FOLLOW_ident_in_partiedef218);
					ident();
					state._fsp--;
			...
			pushFollow(FOLLOW_ptvg_in_partiedef225);
			ptvg();
			state._fsp--;
	...
	public final void partieref() throws RecognitionException {
		try {
			...
			{
			match(input,50,FOLLOW_50_in_partieref237); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_partieref245); 
					pushFollow(FOLLOW_specif_in_partieref247);
					specif();
					state._fsp--;
	...
	public final void specif() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_specif268);
			ident();
			state._fsp--;
			...
			switch (alt10) {
				case 1 :
					...
					{
					match(input,41,FOLLOW_41_in_specif274); 
					match(input,10,FOLLOW_10_in_specif276); 
					...
					while (true) {
						...
						case 1 :
							// projet.g:63:69: ',' type
							{
							match(input,14,FOLLOW_14_in_specif284); 
							pushFollow(FOLLOW_type_in_specif286);
							type();
							state._fsp--;
					...
					match(input,11,FOLLOW_11_in_specif293); 
					}
					break;
			...
			switch (alt12) {
				case 1 :
					...
					{
					match(input,44,FOLLOW_44_in_specif318); 
					match(input,10,FOLLOW_10_in_specif321); 
					pushFollow(FOLLOW_type_in_specif323);
					type();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							// projet.g:64:54: ',' type
							{
							match(input,14,FOLLOW_14_in_specif329); 
							pushFollow(FOLLOW_type_in_specif331);
							type();
							state._fsp--;
					...
					match(input,11,FOLLOW_11_in_specif338); 
					}
					break;
	...
	public final void vars() throws RecognitionException {
		try {
			...
			{
			match(input,54,FOLLOW_54_in_vars388); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_type_in_vars392);
					type();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_vars400); 
							pushFollow(FOLLOW_ident_in_vars403);
							ident();
							state._fsp--;
					...
					pushFollow(FOLLOW_ptvg_in_vars410);
					ptvg();
					state._fsp--;
		...
		try {
			...
			switch (alt16) {
				case 1 :
					// projet.g:73:9: 'ent'
					{
					match(input,34,FOLLOW_34_in_type430); 
					PtGen.pt(34);
					}
					break;
				case 2 :
	...
	public final void corps() throws RecognitionException {
		try {
			...
			pushFollow(FOLLOW_instructions_in_corps538);
			instructions();
			state._fsp--;

			match(input,40,FOLLOW_40_in_corps540); 
			}
	...
	public final void parfixe() throws RecognitionException {
		try {
			...
			{
			match(input,41,FOLLOW_41_in_parfixe552); 
			match(input,10,FOLLOW_10_in_parfixe554); 
			...
			while (true) {
				...
				case 1 :
					// projet.g:90:26: ';' pf
					{
					match(input,18,FOLLOW_18_in_parfixe560); 
			...
			match(input,11,FOLLOW_11_in_parfixe567); 
			}
	...
	public final void pf() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_type_in_pf581);
			type();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_pf589); 
					pushFollow(FOLLOW_ident_in_pf591);
					ident();
					state._fsp--;
	...
	public final void parmod() throws RecognitionException {
		try {
			...
			{
			match(input,44,FOLLOW_44_in_parmod610); 
			match(input,10,FOLLOW_10_in_parmod612); 
			pushFollow(FOLLOW_pm_in_parmod614);
			pm();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					// projet.g:96:26: ';' pm
					{
					match(input,18,FOLLOW_18_in_parmod618); 
					pushFollow(FOLLOW_pm_in_parmod620);
					pm();
					state._fsp--;
			...
			match(input,11,FOLLOW_11_in_parmod624); 
			}
	...
	public final void pm() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_type_in_pm638);
			type();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_pm646); 
					pushFollow(FOLLOW_ident_in_pm648);
					ident();
					state._fsp--;
		...
		try {
			...
			switch (alt29) {
				case 1 :
					...
					{
					match(input,52,FOLLOW_52_in_inssi749); 
					PtGen.pt(51);
					pushFollow(FOLLOW_instructions_in_inssi754);
					instructions();
					state._fsp--;
			...
			match(input,42,FOLLOW_42_in_inssi758); 
			PtGen.pt(52);
			}
		...
		try {
			...
			switch (alt31) {
				case 1 :
					...
					{
					match(input,26,FOLLOW_26_in_inscond827); 
					PtGen.pt(58);PtGen.pt(59);
					pushFollow(FOLLOW_instructions_in_inscond833);
					instructions();
					state._fsp--;
			...
			match(input,39,FOLLOW_39_in_inscond851); 
			PtGen.pt(60);
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,53,FOLLOW_53_in_boucle869); 
			PtGen.pt(53);
			pushFollow(FOLLOW_expression_in_boucle874);
			expression();
			state._fsp--;

			PtGen.pt(8);PtGen.pt(54);
			match(input,36,FOLLOW_36_in_boucle878); 
			pushFollow(FOLLOW_instructions_in_boucle880);
			instructions();
			state._fsp--;

			match(input,37,FOLLOW_37_in_boucle882); 
			PtGen.pt(55);
			}
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture896); 
			match(input,10,FOLLOW_10_in_lecture898); 
			pushFollow(FOLLOW_ident_in_lecture900);
			ident();
			state._fsp--;

			PtGen.pt(43);PtGen.pt(42);
			// projet.g:128:57: ( ',' ident )*
			loop32:
			while (true) {
				int alt32=2;
				...
				switch (alt32) {
				case 1 :
					// projet.g:128:59: ',' ident
					{
					match(input,14,FOLLOW_14_in_lecture907); 
			...
			match(input,11,FOLLOW_11_in_lecture917); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture930); 
			match(input,10,FOLLOW_10_in_ecriture932); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_ecriture940); 
			...
			match(input,11,FOLLOW_11_in_ecriture949); 
			}
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel965);
			ident();
			state._fsp--;
			...
			switch (alt36) {
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_affouappel974); 
					pushFollow(FOLLOW_expression_in_affouappel977);
					expression();
					state._fsp--;

					PtGen.pt(41);PtGen.pt(42);
					}
					break;
				case 2 :
					...
					switch (alt35) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel999);
							effixes();
							state._fsp--;
							...
							switch (alt34) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel1002);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effixes1036); 
			...
			switch (alt38) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_effixes1039);
					expression();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effixes1044); 
							pushFollow(FOLLOW_expression_in_effixes1046);
							expression();
							state._fsp--;
	...
	public final void exp1() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp2_in_exp11129);
			exp2();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_exp11132); 
					PtGen.pt(8);
					pushFollow(FOLLOW_exp2_in_exp11136);
					exp2();
					state._fsp--;

					PtGen.pt(8);PtGen.pt(11);
					}
					break;
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_exp21156); 
					pushFollow(FOLLOW_exp2_in_exp21158);
					exp2();
					state._fsp--;

					PtGen.pt(8);PtGen.pt(12);
					}
					break;
				case 2 :
					// projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21167);
					exp3();
					state._fsp--;
		...
		try {
			...
			switch (alt44) {
				case 1 :
					// projet.g:157:5: '=' exp4
					{
					match(input,22,FOLLOW_22_in_exp31190); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp4_in_exp31196);
					exp4();
					state._fsp--;

					PtGen.pt(7); PtGen.pt(17);
					}
					break;
				case 2 :
					// projet.g:158:5: '<>' exp4
					{
					match(input,21,FOLLOW_21_in_exp31206); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp4_in_exp31211);
					exp4();
					state._fsp--;

					PtGen.pt(7); PtGen.pt(18);
					}
					break;
				case 3 :
					// projet.g:159:5: '>' exp4
					...
					PtGen.pt(7);
					pushFollow(FOLLOW_exp4_in_exp31226);
					exp4();
					state._fsp--;

					PtGen.pt(7); PtGen.pt(15);
					}
					break;
				case 4 :
					// projet.g:160:5: '>=' exp4
				...
				case 5 :
					...
					PtGen.pt(7); PtGen.pt(13);
					}
					break;
				case 6 :
					// projet.g:162:5: '<=' exp4
					{
					match(input,20,FOLLOW_20_in_exp31264); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp4_in_exp31269);
					exp4();
					state._fsp--;

					PtGen.pt(7); PtGen.pt(14);
					}
					break;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_exp41304); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp5_in_exp41308);
					exp5();
					state._fsp--;

					PtGen.pt(7);PtGen.pt(19);
					}
					break;
				case 2 :
					// projet.g:168:10: '-' exp5
					{
					match(input,15,FOLLOW_15_in_exp41322); 
					PtGen.pt(7);
					pushFollow(FOLLOW_exp5_in_exp41326);
					exp5();
					state._fsp--;

					PtGen.pt(7);PtGen.pt(20);
					}
					break;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp51369); 
					PtGen.pt(7);
					pushFollow(FOLLOW_primaire_in_exp51374);
					primaire();
					state._fsp--;

					PtGen.pt(7);PtGen.pt(21);
					}
					break;
				case 2 :
					// projet.g:174:13: 'div' primaire
					{
					match(input,32,FOLLOW_32_in_exp51390); 
					PtGen.pt(7);
					pushFollow(FOLLOW_primaire_in_exp51394);
					primaire();
					state._fsp--;

					PtGen.pt(7);PtGen.pt(22);
					}
					break;
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1419);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1427);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,10,FOLLOW_10_in_primaire1436); 
					pushFollow(FOLLOW_expression_in_primaire1438);
					expression();
					state._fsp--;

					match(input,11,FOLLOW_11_in_primaire1440); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1462); 
				...
				case 4 :
					// projet.g:186:5: 'vrai'
					{
					match(input,55,FOLLOW_55_in_valeur1482); 
					PtGen.pt(3);
					}
					break;
				case 5 :
					// projet.g:187:5: 'faux'
					{
					match(input,38,FOLLOW_38_in_valeur1490); 
					PtGen.pt(4);
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// projet.g:197:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1520); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// projet.g:199:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1531); 
	...
	public static final BitSet FOLLOW_ident_in_unitmodule144 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_unitmodule146 = new BitSet(new long[]{0x00450000A0000000L});
	...
	public static final BitSet FOLLOW_partieref_in_declarations179 = new BitSet(new long[]{0x0041000020000002L});
	public static final BitSet FOLLOW_consts_in_declarations182 = new BitSet(new long[]{0x0041000000000002L});
	public static final BitSet FOLLOW_vars_in_declarations187 = new BitSet(new long[]{0x0001000000000002L});
	public static final BitSet FOLLOW_decprocs_in_declarations192 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_31_in_partiedef209 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_partiedef211 = new BitSet(new long[]{0x0000000000044000L});
	public static final BitSet FOLLOW_14_in_partiedef216 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_partiedef218 = new BitSet(new long[]{0x0000000000044000L});
	public static final BitSet FOLLOW_ptvg_in_partiedef225 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_50_in_partieref237 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_specif_in_partieref240 = new BitSet(new long[]{0x0000000000044000L});
	public static final BitSet FOLLOW_14_in_partieref245 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_specif_in_partieref247 = new BitSet(new long[]{0x0000000000044000L});
	public static final BitSet FOLLOW_ptvg_in_partieref254 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_specif268 = new BitSet(new long[]{0x0000120000000002L});
	public static final BitSet FOLLOW_41_in_specif274 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_specif276 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_specif278 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_specif284 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_specif286 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_specif293 = new BitSet(new long[]{0x0000100000000002L});
	public static final BitSet FOLLOW_44_in_specif318 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_specif321 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_specif323 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_specif329 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_specif331 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_specif338 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_54_in_vars388 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_vars392 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_vars394 = new BitSet(new long[]{0x0000000408044000L});
	public static final BitSet FOLLOW_14_in_vars400 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_vars403 = new BitSet(new long[]{0x0000000408044000L});
	public static final BitSet FOLLOW_ptvg_in_vars410 = new BitSet(new long[]{0x0000000408000002L});
	public static final BitSet FOLLOW_34_in_type430 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_30_in_corps536 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_corps538 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_40_in_corps540 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_41_in_parfixe552 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_parfixe554 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pf_in_parfixe556 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_18_in_parfixe560 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pf_in_parfixe562 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_11_in_parfixe567 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pf581 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf583 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_14_in_pf589 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf591 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_44_in_parmod610 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_parmod612 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pm_in_parmod614 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_18_in_parmod618 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_pm_in_parmod620 = new BitSet(new long[]{0x0000000000040800L});
	public static final BitSet FOLLOW_11_in_parmod624 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pm638 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm640 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_14_in_pm646 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm648 = new BitSet(new long[]{0x0000000000004002L});
	...
	public static final BitSet FOLLOW_52_in_inssi749 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inssi754 = new BitSet(new long[]{0x0000040000000000L});
	public static final BitSet FOLLOW_42_in_inssi758 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_16_in_inscond808 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond810 = new BitSet(new long[]{0x0000008004004000L});
	public static final BitSet FOLLOW_26_in_inscond827 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond833 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_inscond851 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_53_in_boucle869 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_boucle874 = new BitSet(new long[]{0x0000001000000000L});
	public static final BitSet FOLLOW_36_in_boucle878 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_boucle880 = new BitSet(new long[]{0x0000002000000000L});
	public static final BitSet FOLLOW_37_in_boucle882 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_43_in_lecture896 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture898 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture900 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_lecture907 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture909 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_lecture917 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture930 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture932 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture934 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_ecriture940 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture942 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_ecriture949 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel965 = new BitSet(new long[]{0x0000000000020402L});
	public static final BitSet FOLLOW_17_in_affouappel974 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_affouappel977 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel999 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_effmods_in_affouappel1002 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effixes1036 = new BitSet(new long[]{0x008040400000AC60L});
	public static final BitSet FOLLOW_expression_in_effixes1039 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effixes1044 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_effixes1046 = new BitSet(new long[]{0x0000000000004800L});
	...
	public static final BitSet FOLLOW_exp2_in_exp11129 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_35_in_exp11132 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp11136 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_46_in_exp21156 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp21158 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp3_in_exp21167 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31183 = new BitSet(new long[]{0x0000000001F80002L});
	public static final BitSet FOLLOW_22_in_exp31190 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31196 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_exp31206 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_exp4_in_exp31226 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_19_in_exp31249 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31255 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp31264 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31269 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp5_in_exp41292 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_13_in_exp41304 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41308 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_15_in_exp41322 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41326 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_primaire_in_exp51353 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_12_in_exp51369 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51374 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_32_in_exp51390 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51394 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1419 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1427 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_primaire1436 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_primaire1438 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_primaire1440 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1454 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1462 = new BitSet(new long[]{0x0000000000000040L});
	...
	public static final BitSet FOLLOW_55_in_valeur1482 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1490 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1520 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1531 = new BitSet(new long[]{0x0000000000000002L});
}
