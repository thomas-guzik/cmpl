...
fichier DeclExp-T1.pro : teste un certain nombre de déclarations et expressions
	fichiers 
DeclExp-Err1.pro à DeclExp-Err5.pro: testent un certain nombre d'erreurs (un type d'erreur par fichier)
...
fichiers polyPxx-exoyy.pro: exercice yy, page xx du poly de TP
	fichiers 
polyPxx-exempleyy.pro: exemple (DONT VOUS AVEZ LA SOLUTION dans le poly), page xx du poly de TP 
